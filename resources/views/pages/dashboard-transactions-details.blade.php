                ...
                <div class="col-12 col-md-8">
                  <div class="row">
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">Rizky Ramadhani</div>
                    </div>
                    <div class="col-12 col-md-6">
                      <div class="product-title">Product name </div>
                      <div class="product-subtitle">Sirup Marzzan</div>
                    </div>
                    <div class="col-12 col-md-6">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">+62 8384 1360 6</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-12">
                  <div class="row">
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">Perum Podo Asih</div>
                    </div>
                    <div class="col-12 col-md-6">
                      <div class="product-title">Address II</div>
                      <div class="product-subtitle">Blok AC No.3</div>
                    </div>
                    <div class="col-12 col-md-6">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">Pasuruan</div>
                    </div>
                    <div class="col-12 col-md-6">
                      <div class="product-title">Postal Code </div>
                      <div class="product-subtitle">67154</div>
                    </div>
                    <div class="col-12 col-md-6">
